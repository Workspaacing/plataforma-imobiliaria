    ...
    <div className="flex min-h-svh flex-col bg-muted/40">
      ...
      <main className="flex flex-1 justify-center px-4 pb-10 md:items-center">
        <Card className="w-full max-w-2xl">
          <CardHeader>
            <CardTitle>
              {hasOrganizations ? "Nova imobiliária" : "Crie sua imobiliária"}
            </CardTitle>
            <CardDescription>
              {firstName ? `${firstName}, ` : ""}
              {hasOrganizations
                ? "cadastre mais uma imobiliária. Você será o dono dela e poderá alternar entre elas pelo menu."
